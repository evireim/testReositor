...
//1й параметр - что должно произойти. 2й параметр - через какое время это произойдёт в мс.
// setTimeout(function() {
//   alert("Реклама");
// }, 5000);

// //setInterval() - позволяет повторятьдействие через каждый  промежуток времени
...
// //Нужен, когда необходимо варьяировать время

// setTimeout(handler, 2000); 
// function handler() {
//   let randomTime = 1000 + Math.floor(Math.random() * 2000);
//   console.log("Следующий вывод через " + randomTime + "ms");
//   setTimeout(() => {
//     if (randomTime > 2900) {
...
//     }
//     return handler();
//   }, randomTime); //В данном случае время следующего вызова варьируется в диапозоне от 1000мс до 3000мс
// }
